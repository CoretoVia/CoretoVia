...
**Т6** (`docs/14-dalgat.md:108`, регистър `beleg: "Т6"`): „Четири забрани в слоевете броят
...
Т6 иска същото: пробни файлове, които трябва да **ПАДНАТ**.
...
| `src/iztochnik/pogasitelen-plan.ts` | `04-krediti:73` | същото (регистър, П11) |
