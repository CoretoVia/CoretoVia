...
| — решени от кода | **30** | същото |
| — още открити | **15** | същото |
| — отпаднали | **9** | същото |
| — още неустановени | **57** | същото |
| реда в дълга | **307** | `docs/14-dalgat.md` |
...
| [`03-plan.md`](../docs/03-plan.md) | план · жив | ПЛАН ЗА ИЗПЪЛНЕНИЕ · резените на Coretovia |
...
**Броено при последното писане на картата:** 176 документа в 15 папки.
