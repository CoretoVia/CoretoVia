...
export const VID = Object.freeze({
  ...
  zadacha: 'zadacha',
  /** ред с пари от листа Сметки · приход или разход, по знака (правило 16) */
  dvizhenie: 'dvizhenie',
  ...
  kniga: 'kniga',
  /**
   * СТРУКТУРАТА на една таблица · id = ключът на таблицата (десетият тип).
   *
   * Адресът е таблицата, не колоната: две промени върху една таблица трябва
   * да се засекат от rev-предпазителя, инак вторият раздел добавя колона
