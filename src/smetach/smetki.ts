...
export const IZVEDENITE_NA_SMETKITE: readonly IzvedenaKolona[] = Object.freeze([
  ...
  },
  {
    ...
    ime: 'Кеш изтеглено',
    pomosht: pomosht(
      'Изтегленото в брой по банковото извлечение за месеца, от реда на кеша. Сверка: дадено ↔ изтеглено.',
  ...
  },
  {
    ...
    ime: 'Кеш вкарано',
    pomosht: pomosht(
      'Сборът на редовете в Заплати Кеш и Фактури Кеш за месеца, взет без знака — разходите са с минус. Сверка: дадено ↔ вкарано по редовете.',
      'сбор на Заплати Кеш + Фактури Кеш за месеца, без знака · сверка: дадено ↔ вкарано',
    ),
  },
]);
