 ...
 *
 * ЗНАКЪТ СЕ ПАЗИ. Не е украса: разходът е отрицателен по знак (правило 16), а
 * деленето на отрицателно число трябва да върне отрицателен резултат със същата
 * големина — иначе ДДС-то на един разход не е точно минус ДДС-то на равния му
 * приход и сверката не затваря на нула.
 *
