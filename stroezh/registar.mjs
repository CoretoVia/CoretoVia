...
function eNomerNaIziskvane(red, nachalo, sled) {
  ...
  /**
   * „инвариант А24" · ИД НА ИНВАРИАНТ, НАЗОВАН С ДУМА, в изречение.
   *
   * Горното правило иска ид-то да стои САМО в клетка. Но документ, който
   * ОБСЪЖДА инварианти, ги цитира в текст: „обход 6 не лови невиканото
   * (инвариант А24)". Мястото вече не го отличава — отличава го ДУМАТА пред
   * него, и тя е недвусмислена: белег на въпрос никога не се пише „инвариант
   * Т14".
   *
   * Списък след думата също се пропуска („инварианти Г8 · Д10"), затова
   * между думата и ид-то се допускат други ид-та и разделители.
   *
   * Платено на 10.09.2026: `docs/35` цитира пет инварианта в проза и портата
   * ги обяви за непознати въпроси. Стеснението беше по-тясно от езика.
   */
