 ...
 *     евристиките на `registar.mjs` са ги родили от номера на изисквания (2.0в ги трие).
 ...
 * белег в жив документ е находка. Следва 2.0в — `registar.mjs` губи евристиките си.
 */
